...
<a href="<?php echo $project->url() ?>" style="background-image:url('/assets/img/thumb-<?php echo $project->projecttype ?>_purus.png')" title="Purus" class="link-button <?php echo $project->projecttype_button ?>" data-tooltip="Purus"><p>Purus</p></a>
<a href="<?php echo $project->url() ?>" style="background-image:url('/assets/img/thumb-<?php echo $project->projecttype ?>_stash.png')" title="Stash Furniture" class="link-button <?php echo $project->projecttype_button ?>" data-tooltip="Stash Furniture"><p>Stash Furniture</p></a>
